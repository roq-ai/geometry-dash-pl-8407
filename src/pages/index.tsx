...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`geometry dash platform `}</title>

        <meta
          name="description"
          content="Experience Geometry Dash Platform - Where Normal Meets Fun! Unleash Your Creativity and Master the Game of Shapes and Strategies. Dare to Dash, Dare to Dream!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1498940757830-82f7813bf178?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmdW58ZW58MHx8fHwxNjk1MjE2NzY3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@greysonjoralemon?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Greyson Joralemon`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Geometry Dash Platform - Where Normal Meets Fun! Unleash Your Creativity and Master the Game of Shapes and Strategies. Dare to Dash, Dare to Dream!`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Game Owner" type="game-owner" abilities={appConfig.ownerAbilities} />
