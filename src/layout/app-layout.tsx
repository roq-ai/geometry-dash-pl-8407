...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['game-owner', 'game-administrator', 'game-developer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'New Tables', path: '/new-tables', entity: 'new_table', service: AccessServiceEnum.PROJECT, icon: FiGrid },
    {
      name: 'New Table Iwfbs',
      path: '/new-table-iwfbs',
      entity: 'new_table_iwfb',
      service: AccessServiceEnum.PROJECT,
      icon: FiLayers,
    },
    {
      name: 'New Table Zxqos',
      path: '/new-table-zxqos',
      entity: 'new_table_zxqo',
      service: AccessServiceEnum.PROJECT,
      icon: FiDatabase,
    },
